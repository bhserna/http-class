...
app.get('/', (req, res) => {
  ...
  const filteredMovies = selectedScore && movies.filter((movie) => movie.score.toString() === selectedScore);

  res.render("index", { movies: filteredMovies || movies, scores: scores, selectedScore: selectedScore })
});
